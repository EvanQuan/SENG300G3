...
public class TypeVisitorI2G9 extends ASTVisitor {
	 ...
	 * matches the specified declaration type for classes and interfaces
	 */
	@Override
	...
	/**
	 * Used for Enum declarations Gets the name of the node and compares to the type
	 * to look for, if the same increases dCount by 1
	 * 
	 * @param node
	 *            of the type EnumDeclaration
	...
	/**
	 * Used for Annotation declarations Gets the name of the node and compares to
	 * the type to look for, if the same increases dCount by 1
	 * 
	 * @param node
	 *            of the type AnnotationTypeDeclaration
	 * @return true to visit the children nodes
	 */
	@Override
	...
	/**
	 * @param node
	 *            of type VariableDeclarationFragment Resolves the bindings so we
	 *            can acquire the node's full name
