...
public class TypeVisitorPrimitiveTest extends TypeVisitorTest {
	...
	/**
	 * Check that being in package pack does not append package name to primitive
	 * type double
	 */
	@Test
	...
	/**
	 * Check that declaring short while importing class pack.short does not override
	 * the primitive
	 */
	@Test
	...
	/**
	 * Check that declaring a long variable and casting a short to a long counts as
	 * 2 references
	 */
	@Test
	...
	/**
	 * Check that attempting to declare int as a class is not successful and does
	 * not count as a declaration of int
	 */
	@Test
	...
	/**
	 * Check that void is never counted as a type, despite default counting as a
	 * primitive in the AST
	 */
	@Test
	public void test_void_Dec_0_Ref_0() {
		configureParser("public Class Other { public static void main(String[] args){} }", "void", 0, 0);
	}
}
